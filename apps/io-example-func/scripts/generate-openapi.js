import { buildOpenApiDocument, writeOpenApiYaml, } from "@pagopa/io-core-openapi";
/**
 * Static generator for the io-example-func OpenAPI specification.
...
const document = buildOpenApiDocument({
    document: {
        info: {
            description: "Example Azure Functions v4 app following the hexagonal architecture pattern.",
            license: { identifier: "MIT", name: "MIT" },
            title: "io-example-func",
            version: "0.0.1",
        },
        security: [],
        servers: [
    ...
    registerComponents: (registry) => {
        registry.registerComponent("securitySchemes", "functionKey", {
            description: "Azure Functions host key passed as the `x-functions-key` header.",
            in: "header",
...
if (result.kind === "check-failed") {
    console.error("[generate-openapi] " +
        result.path +
