...
- f77022a: Introduce `@pagopa/hexagonal-openapi`, the code-first OpenAPI toolkit for the IO platform: declare HTTP routes as framework-agnostic contracts built from Zod, generate an OpenAPI 3.1 document from them, and serialize it to YAML.
