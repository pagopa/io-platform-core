...
| <a name="provider_azurerm.PROD-IO"></a> [azurerm.PROD-IO](#provider\_azurerm.PROD-IO) | 4.72.0 |

## Modules

| Name | Source | Version |
|------|--------|---------|
| <a name="module_azure-PROD-IO_bootstrap"></a> [azure-PROD-IO\_bootstrap](#module\_azure-PROD-IO\_bootstrap) | pagopa-dx/azure-github-environment-bootstrap/azurerm | ~> 4.0 |
